...
from smutils.bbox.transforms import bbox_xyxy_to_cxcyah, bbox_cxcyah_to_xyxy
...
class ByteTracker(BaseTracker):
    ...
    def __init__(self,
        ...
        self.use_cate_match = use_cate_match
        self.use_second_match_case = use_second_match_case
    ...
    def track(self,
        ...
        if self.empty or bboxes.size(0) == 0:
            ...
            #     (self.tracks[id].mean, self.tracks[id].covariance) = self.kf.predict(self.tracks[id].mean, self.tracks[id].covariance)
